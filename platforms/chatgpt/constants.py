...
OPENAI_API_ENDPOINTS = {
    ...
    "password_verify": f"{OPENAI_AUTH}/api/accounts/password/verify",
    "mfa_issue_challenge": f"{OPENAI_AUTH}/api/accounts/mfa/issue_challenge",
    "mfa_verify": f"{OPENAI_AUTH}/api/accounts/mfa/verify",
